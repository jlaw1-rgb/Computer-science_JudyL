...
public interface ElementalAttacks {
    ...
    default void attack(Monster opponent) {
        ...
        if (.hasUsedDoubleDown() == false
            ...
            if (att < 10) {
                ...
                performSingleElementalAttack(att, opponent);
            } else {
    ...
    default void performSingleElementalAttack(int attackNumber, Monster opponent) {
        int totalDamage = 10 * (attackNumber) * (attackNumber / opponent.getDefense());
    ...
    // return. The monster effectively loses their turn.
