...
public class ArrayListPractice {
    ...
    // firstLetter. Remove them by iterating from the beginning of the list.
    ...
    // removes all Strings in the ArrayList that begin with the same letter as
    // firstLetter. Remove them by iterating from the end of the list.
    ...
    // ArrayList. It iterates through the list using a For-Each Loop.
